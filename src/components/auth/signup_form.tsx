...
const formSchema = z.object({
  ...
  password: z.string()
    .min(8, {
      message: "পাসওয়ার্ড অবশ্যই কমপক্ষে ৮ অক্ষরের হতে হবে।",
    })
    .max(32, {
      message: "পাসওয়ার্ড ৩২ অক্ষরের বেশি হতে পারবে না।",
    })
    .regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]/, {
      message: "পাসওয়ার্ডে কমপক্ষে একটি বড় অক্ষর, একটি ছোট অক্ষর, একটি সংখ্যা এবং একটি বিশেষ অক্ষর থাকতে হবে।",
    }),
})
