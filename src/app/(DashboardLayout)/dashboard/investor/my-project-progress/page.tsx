...
import { TrendingUp, Calendar, Image as ImageIcon, RefreshCw, ArrowLeft } from 'lucide-react';
...
const MyProjectProgress = async () => {
  ...
  const stats = {
    ...
    totalUpdates: projects.reduce((sum, project) => sum + project.project.progressUpdate.length, 0),
    totalImages: projects.reduce((sum, project) => sum + project.project.progressUpdateImage.length, 0),
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <span>প্রতিটি আপডেটে বিস্তারিত তথ্য এবং ছবি থাকে</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
            ...
            <div className="space-y-3">
              <h4 className="font-semibold text-foreground">স্ট্যাটাস</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  <Badge variant="secondary" className="text-xs">বিচারাধীন</Badge>
                  <span>- বিনিয়োগ রিভিউ চলছে</span>
                </li>
                <li className="flex items-start gap-2">
                  <Badge variant="default" className="text-xs">অনুমোদিত</Badge>
                  <span>- বিনিয়োগ গ্রহণ করা হয়েছে</span>
                </li>
                <li className="flex items-start gap-2">
                  <Badge variant="destructive" className="text-xs">প্রত্যাখ্যাত</Badge>
                  <span>- বিনিয়োগ গ্রহণ করা হয়নি</span>
                </li>
              </ul>
            </div>
          </div>
